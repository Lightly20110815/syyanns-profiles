...
function TagsCard({ tags }) {
  return (
    <div className="glass-card flex-row justify-center items-center flex-wrap" style={{ height: '100%', alignContent: 'center', gap: '1rem 0.75rem', paddingTop: '2.5rem', paddingBottom: '2.5rem' }}>
      {tags.map((tag, index) => {
